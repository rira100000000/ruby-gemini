...
RSpec.describe Gemini::HTTP do
  ...
  describe "#get" do
    it "sends GET request with API key parameter" do
    ...
    it "can include additional parameters" do
  ...
  describe "#post" do
    it "sends POST request with API key parameter" do
  ...
  describe "#json_post" do
    it "sends POST request with JSON body and API key parameter" do
    ...
    it "can include query parameters" do
  ...
  describe "#multipart_post" do
    ...
    before do
      # Register multipart adapter
      require 'faraday/multipart'
    end

    it "sends POST request with multipart form data" do
  ...
  describe "#delete" do
    it "sends DELETE request with API key parameter" do
  ...
  describe "#parse_json" do
    ...
    it "converts multi-line JSON objects to array" do
      json = "{}\n{}"
      expect(instance.send(:parse_json, json)).to eq([{}, {}])
    end

    it "returns non-JSON string as is" do
      text = "plain text"
  ...
  describe "timeout handling" do
    ...
    before do
      # Stub request that will timeout
      stub_request(:get, "https://api.gemini.com/v1beta/test?key=test-api-key")
        .to_timeout
